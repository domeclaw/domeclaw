...
import (
	...
	anthropicprovider "github.com/sipeed/domeclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: domeclaw auth login --provider anthropic")
		}
